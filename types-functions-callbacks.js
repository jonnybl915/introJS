...
var average = function average(num, num2) {
	return (sum(num, num2) / 2);
}
...
var sum = function sum(num, num2) {
 ...
 } else if ((isNegative(num)) || (isNegative(num2))) {
	 return null;
 }
...
var minimum = function findMin(num, num2, num3, num4) {
...
var justOneString = function strangFunc(input, input2) {
	if ((typeof(input) === 'string' && typeof(input2) != 'string') || (typeof(input2) === 'string' && typeof(input) != 'string')) {
		return true;
	}
	else  {
		return false;
...
//-----------------BEFORE CLASS-------------
// var doTwice = function doTwice(funct) {
//
// 	var resultOf = doTwice;
// 	var doTwice = function doTwice(resultOf) {
// 		return doTwice;
// 	}
// }

var doTwice = function (func) {
	var firstResult = func();
	var secondResult = func(firstResult);
	return secondResult;
}
...
var conditionallyInvoke = function(funky) {
	if (ORACLE === 'YES'){
		return funky();
	} else {
		return;
